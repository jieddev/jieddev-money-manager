...
### Tech Stack
- Frontend
  - **Flutter** will be used for this project since it offers a home widget package and is best when handling with home widget feature and is cross-platform so that it supports both Android and IOS.
- Backend
	- API Planning:
	- Authentication:
- Database
  - **SQLite** will be used for the project using the **sqflite** flutter package for Flutter to communicate with the native SQLite. SQLite is used since the app prioritize offline.
  - ERD:
